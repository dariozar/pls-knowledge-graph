...
> Il clustering gerarchico è una tecnica di analisi dei dati che raggruppa oggetti in una struttura ad albero (dendrogramma) in base alla loro similarità (o dissimilarità). A differenza del clustering partizionale, non richiede la specificazione a priori del numero di cluster; la gerarchia emerge naturalmente dal processo aggregativo (o divisivo).
